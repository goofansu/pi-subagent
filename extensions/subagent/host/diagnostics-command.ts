/**
 * `/subagent`: what the live Session's runtime is counting and holding.
 *
...
export const DIAGNOSTICS_COMMAND_NAME = "subagent";
...
export function registerDiagnosticsCommand(
  ...
  pi.registerCommand(DIAGNOSTICS_COMMAND_NAME, {
    description: "Report the Session's runtime counters and cleanup probes.",
