...
//
// Usage: node --import tsx scripts/v2-claude-live-smoke.mjs
//
...
// needs. Override the family with V2_CLAUDE_LIVE_MODEL and the overall bound
// with V2_CLAUDE_LIVE_TIMEOUT_MS. This spends provider quota and is not part
// of `npm run check`.
...
const SUCCESS_MARKER = "V2_CLAUDE_LIVE_SMOKE_PASS";
const FAILURE_MARKER = "V2_CLAUDE_LIVE_SMOKE_FAIL";

const timeoutMs = Number(process.env.V2_CLAUDE_LIVE_TIMEOUT_MS ?? 420_000);
const model = process.env.V2_CLAUDE_LIVE_MODEL ?? "haiku";
const failures = [];
let interrupted;
