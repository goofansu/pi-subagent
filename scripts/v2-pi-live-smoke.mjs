...
//
// Usage: node --import tsx scripts/v2-pi-live-smoke.mjs
//
...
// V2_PI_LIVE_MODEL and the overall bound with V2_PI_LIVE_TIMEOUT_MS. This
...
import { createPiBackendSet } from "../extensions/subagent-v2/host/pi-backends.ts";
...
const SUCCESS_MARKER = "V2_PI_LIVE_SMOKE_PASS";
const FAILURE_MARKER = "V2_PI_LIVE_SMOKE_FAIL";
